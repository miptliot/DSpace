 ...
 */
public class OAuthLogin extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    /**language strings */
    public static final Message T_title =
            message("xmlui.EPerson.OAuthLogin.title");

    public static final Message T_dspace_home =
            message("xmlui.general.dspace_home");

    public static final Message T_trail =
            message("xmlui.EPerson.OAuthLogin.trail");

    public static final Message T_head1 =
            message("xmlui.EPerson.OAuthLogin.head1");

    public static final Message T_email_address =
            message("xmlui.EPerson.OAuthLogin.email_address");
    ...
    public static final Message T_password =
            message("xmlui.EPerson.OAuthLogin.password");

    public static final Message T_forgot_link =
            message("xmlui.EPerson.OAuthLogin.forgot_link");

    public static final Message T_submit =
            message("xmlui.EPerson.OAuthLogin.submit");

    public static final Message T_head2 =
            message("xmlui.EPerson.OAuthLogin.head2");

    public static final Message T_para1 =
            message("xmlui.EPerson.OAuthLogin.para1");
            ...
            WingException
    {
        ...
        Division login = body.addInteractiveDivision("login", contextPath
                + "/oauth-login", Division.METHOD_POST, "primary");
        login.setHead(T_head1);

        List list = login.addList("oauth-login",List.TYPE_FORM);
